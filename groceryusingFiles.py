...
grocery_file = open("grocery.txt",'w');
grocery_file.write(str(grocery_shop));
grocery_file.close()
...
# checking password
	...
	while (owner_oper !=0):
		if owner_oper == 1:
			...
			grocery_file = open("grocery.txt",'r');
			print(grocery_file.read())
			print("-----------------------------------------")
			...
			print(grocery_shop)
			grocery_file = open("grocery.txt",'a');
			grocery_file.write("\n\n****new products****\n\n")
			grocery_file.write(str(grocery_shop));
			grocery_file.close()
